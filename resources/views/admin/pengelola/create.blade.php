...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Buat Account Kepala Cabang</h1>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pengelola.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf


                        <div class="form-group">
                            <label>NAMA KEPALA CABANG</label>
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Kepala Cabang"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cabang" min="0" value="{{ old('cabang') }}" placeholder="Masukkan Alamat Kantor Cabang"
