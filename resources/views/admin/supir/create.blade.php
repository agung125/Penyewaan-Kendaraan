        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-user-circle"></i> Tambah User</h4>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.supir.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Supir"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nomer" min="0" value="{{ old('nomer') }}" placeholder="Masukkan Nomer Supir"
